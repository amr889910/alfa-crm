...
export default function CRMSystem() {
  ...
  return (
    <div className="min-h-screen bg-crm-gradient text-white overflow-x-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        <div className="text-center mb-16 lg:mb-24">
          <div className="inline-flex items-center gap-4 bg-gradient-to-r from-white/20 to-slate-200/20 backdrop-blur-xl px-8 py-4 rounded-3xl border border-white/10 mb-8 shadow-2xl">
            ...
            <div>
              <h1 className="text-4xl lg:text-6xl xl:text-7xl font-black bg-gradient-to-r from-white via-blue-300 to-purple-300 bg-clip-text text-transparent leading-tight">نظام إدارة علاقات العملاء</h1>
...
const UpcomingFollowUps = ({ customers }: { customers: Customer[] }) => (
  ...
  <div>
    ...
    {totalPages > 1 && (
      <div className="flex justify-center items-center gap-3 mt-10 pt-8 border-t border-white/10">
        <button disabled={page === 1} onClick={() => setPage(p => p - 1)} className="px-4 py-2 bg-white/10 hover:bg-white/20 disabled:opacity-30 rounded-xl transition font-bold">السابق</button>
        ...
        <button disabled={page === totalPages} onClick={() => setPage(p => p + 1)} className="px-4 py-2 bg-white/10 hover:bg-white/20 disabled:opacity-30 rounded-xl transition font-bold">التالي</button>
      </div>
    )}
  </div>
);
